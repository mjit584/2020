...
tl
    ...
    .fromTo("section.panel.thirty-one", 1, { x: "100%" }, { x: "0%", ease: Linear.easeNone })
    .fromTo("section.panel.thirty-two", 1, { x: "100%" }, { x: "0%", ease: Linear.easeNone })
    .fromTo("section.panel.thirty-three", 1, { x: "100%" }, { x: "0%", ease: Linear.easeNone })
    .fromTo("section.panel.thirty-four", 1, { x: "100%" }, { x: "0%", ease: Linear.easeNone })
    .fromTo("section.panel.thirty-five", 1, { x: "100%" }, { x: "0%", ease: Linear.easeNone })
    .fromTo("section.panel.thirty-six", 1, { x: "100%" }, { x: "0%", ease: Linear.easeNone })
    .fromTo("section.panel.thirty-seven", 1, { x: "100%" }, { x: "0%", ease: Linear.easeNone })
    ...
    .fromTo("section.panel.fifty-one", 1, { x: "100%" }, { x: "0%", ease: Linear.easeNone })
    .fromTo("section.panel.fifty-two", 1, { x: "100%" }, { x: "0%", ease: Linear.easeNone })
    .fromTo("section.panel.fifty-three", 1, { x: "100%" }, { x: "0%", ease: Linear.easeNone })
    .fromTo("section.panel.fifty-four", 1, { x: "100%" }, { x: "0%", ease: Linear.easeNone })
    .fromTo("section.panel.fifty-five", 1, { x: "100%" }, { x: "0%", ease: Linear.easeNone })
    .fromTo("section.panel.fifty-six", 1, { x: "100%" }, { x: "0%", ease: Linear.easeNone })
